    ...
    <ul class="text-white navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="admin.php">Home</a>
         ...
         <li class="nav-item">
        <a class="nav-link text-white" href="check_Carts.php" >Cart<span id="cart" class="badge badge-warning mx-2"></span></a>
      </li>
         <li class="nav-item">
        <a class="nav-link text-white" href="views/post.php">Add Fashions</a>
      </li>
      <li class="nav-item">
